        ...
        <div className='flex h-[58px] flex-col items-center justify-end'>
          ...
          >
            <g clipPath='url(#clip0_1_629)'>
              ...
              >
                <path
                  d='M65.9255 45.1387H0V0.174316H65.9255V45.1387Z'
                  fill='#484848'
                />
              </mask>
              <g mask='url(#mask0_1_629)'>
                <path
                  fillRule='evenodd'
                  clipRule='evenodd'
                  d='M3.98455 1.95318C2.79154 1.95318 1.82066 2.9011 1.82066 4.06603V41.2468C1.82066 42.412 2.79154 43.3599 3.98455 43.3599H61.941C63.134 43.3599 64.1049 42.412 64.1049 41.2468V4.06603C64.1049 2.9011 63.134 1.95318 61.941 1.95318H3.98455ZM3.98455 45.1387C1.78743 45.1387 -3.05176e-05 43.3928 -3.05176e-05 41.2468V4.06603C-3.05176e-05 1.92027 1.78743 0.174316 3.98455 0.174316H61.941C64.1383 0.174316 65.9256 1.92027 65.9256 4.06603V41.2468C65.9256 43.3928 64.1383 45.1387 61.941 45.1387H3.98455Z'
                  fill='#484848'
                />
              </g>
              <path
              ...
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M10.6129 16.2848C13.5176 16.2848 15.8725 14.012 15.8725 11.2085C15.8725 8.40505 13.5176 6.13232 10.6129 6.13232C7.70826 6.13232 5.35342 8.40505 5.35342 11.2085C5.35342 14.012 7.70826 16.2848 10.6129 16.2848Z'
                fill='#3782F7'
              />
              <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M14.8424 24.6277H6.66276C6.16002 24.6277 5.75241 24.2295 5.75241 23.7383C5.75241 23.2471 6.16002 22.8489 6.66276 22.8489H14.8424C15.3452 22.8489 15.7528 23.2471 15.7528 23.7383C15.7528 24.2295 15.3452 24.6277 14.8424 24.6277Z'
                fill='#484848'
              />
              <path
                fillRule='evenodd'
        ...
        <div className='flex h-[58px] flex-col items-center justify-end'>
          ...
          >
            <g clipPath='url(#clip0_1_660)'>
              ...
              />
              <path
                d='M32.8182 0.299805H23V10.7215H32.8182V0.299805Z'
                fill='#4C8CF1'
              />
              <path
                fillRule='evenodd'
