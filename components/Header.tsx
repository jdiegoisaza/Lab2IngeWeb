  ...
  <>
    <header className='flex h-full w-screen justify-center bg-[#fff159]'>
      <div className='mx-4 my-0 flex h-[100px] w-[1200px] flex-col justify-center gap-[20px]'>
        <div className='relative -left-4 flex items-center gap-[50px] justify-self-start'>
          ...
          <div>
            <input
              ...
              className='shadowed h-[40px] w-[600px] border-none bg-white p-4 focus:outline-none'
            />
            <button
              type='button'
              title='search'
        ...
        <div className='relative flex items-center justify-between gap-[100px]'>
          <div>
          ...
          <div className='absolute -bottom-[35px] right-0 flex'>
            ...
            <div className='ml-12 cursor-pointer'>
              ...
              <span className='relative -right-3 -top-8 text-[12px] text-xl font-bold text-white '>
                0
              </span>
            </div>
          </div>
